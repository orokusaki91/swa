...
<body onload="loader()" style="{{ Route::getCurrentRoute()->uri() == '/' ? 'background: url("storage/uploads/home/' . $home->images->first()->path . '") center no-repeat;' : '' }} {{ Route::getCurrentRoute()->uri() == 'kontakt' ? 'background: url("storage/uploads/kontakt/' . $contact->images()->first()->path . '") center no-repeat;' : '' }} background-size: cover; background-attachment: fixed;">
	<!-- Loader start -->
	<div id="loader"></div>
	<!-- Loader end -->
	<!-- Mobile start -->
