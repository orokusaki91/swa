			...
			<div class="row">
				<div class="col-md-6">
					<div class="service-item wow slideInUp">
						...
						<h5>Ihre vorteile</h5>
						<ul>
							<li>Unsere Pikettkräfte sind schnell vor Ort, organisiert und flexibel</li>
					...
					<div class="service-item wow slideInUp">
						...
						<ul>
							<li>Sicherheitsanalyse während der Projektierungsphase / Planung und Umsetzung eines bedürfnisgerechten Sicherheitskonzepts</li>
							<li>Permanente oder punktuelle Bewachung in allen Bauphasen, um Elementarschäden oder böswillige Handlungen (Diebstahl, Vandalismus) zu verhindern</li>
							<li>Kontrolle der Zufahrts- und Zugangsbewilligungen auf die Baustelle</li>
							<li>Überwachung des Materialumschlags zwecks Diebstahlprävention</li>
							<li>Obligatorische Kontrolle und Durchsetzung von Arbeitssicherheitsrichtlinien</li>
						</ul>
					</div>
				</div>
				<div class="col-md-6">
					<div class="service-item wow slideInUp">
						...
						<ul>
							...
							<li>Kontrolle der Aussenhülle des Gebäude auf Defekte und Leckagen</li>
							<li>Kontrolle der Umfriedung (Zäune, Mauer, usw.) auf Defekte</li>
							<li>Wegweisung von Personen, die sich unberechtigterweise auf dem Areal befinden</li>
							<li>Kontrolle Fuhr/Wagenpark auf Verschluss (Diebstahlgefahr)</li>
						</ul>
						<h5>Innenkontrolle:</h5>
						<ul>
							<li>Löschen von Lichtquellen</li>
							<li>Schliessen der Fenster (bei Aussenkontrolle gesichtet)</li>
							<li>Schliessen der Büroräume, Archive, usw.</li>
							<li>Kontrolle Technische Räume (BMA, Server, Heizung Kühlung, Lüftung)</li>
							<li>Kontrolle WC-Anlagen (Rohrbruch, Wasserschaden)</li>
							<li>Kontrolle Küche, Kantine, Aufenthaltsraum mit Kochnische (Herdplatten)</li>
							<li>Kontrolle Lifte</li>
							<li>Allgemeine Kontrolle auf Defekte und Leckagen</li>
							<li>Kontrolle Personal (Legitimation) mit Vermerk von Name und ev. Ausweis auf Rapport</li>
						</ul>
						<p>Um eine Professionelle Arbeit zu garantieren Installieren wir für Sie ein Zeiterfassungssystem (Auswertung der Kontrollen in Mail-Form Ende Monat an Kunde).</p>
					</div>
				</div>
			</div>
		</div>
