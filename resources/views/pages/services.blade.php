			...
			<div class="col-md-6 col-lg-4 mb-5">
				<div class="item wow slideInUp">
					...
					<h3 class="text-center">
						<a href="{{ url('guarding') }}">Bewachung</a>
					</h3>
					...
					<div class="text-center">
						<a class="btn btn-readMore" href="{{ url('guarding') }}" role="button">Alles sehen</a>
					</div>
				</div>
			</div>
			<div class="col-md-6 col-lg-4 mb-5">
				<div class="item wow slideInUp">
					...
					<div class="text-center">
						<a class="btn btn-readMore" href="{{ url('order') }}" role="button">Alles sehen</a>
					</div>
				</div>
			</div>
			<div class="col-md-6 col-lg-4 mb-5">
				<div class="item wow slideInUp">
					...
					<h3 class="text-center">
						<a href="{{ url('protection') }}">Schutz</a>
					</h3>
					...
					<div class="text-center">
						<a class="btn btn-readMore" href="{{ url('protection') }}" role="button">Alles sehen</a>
					</div>
				</div>
			</div>
			<div class="col-md-6 col-lg-4 mb-5">
				<div class="item wow slideInUp">
					...
					<div class="text-center">
						<a class="btn btn-readMore" href="{{ url('ocassion') }}" role="button">Alles sehen</a>
					</div>
				</div>
			</div>
			<div class="col-md-6 col-lg-4 mb-5">
				<div class="item wow slideInUp">
					...
					<div class="text-center">
						<a class="btn btn-readMore" href="{{ url('traffic') }}" role="button">Alles sehen</a>
					</div>
				</div>
			</div>
		</div>
