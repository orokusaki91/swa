			...
			<div class="row">
				<div class="col-md-6">
					<div class="service-item wow slideInUp">
						...
						<ul>
							<li>Erstellung und Planung von Verkehrs - und Sicherheitskonzepten</li>
							<li>Permanente Verkehrsregelung an Strassenkreuzungen</li>
							<li>Verkehrsregelung bei Baustellen / Schaltung von Lichtsignalen</li>
							<li>Verkehrsregelung und Parkdienst im Rahmen von Veranstaltungen</li>
							<li>Verkehrsregelung bei Überquerungen von Fussgängerstreifen / Schulweg</li>
							<li>Organisation des Verkehrs und Sicherung von Arealen in ausserordentlichen Situationen</li>
							<li>Ticketverkauf und Organisation</li>
							<li>Hilfeleistungen und Mithilfe bei Unfällen / Unterstützung der Polizei im Strassenverkehr (z.B. bei Unwetterschäden, Naturkatastrophen und bei Grossveranstaltungen)</li>
							<li>Begleitung von Schwertransporten</li>
						</ul>
					...
					<div class="service-item wow slideInUp">
						...
						<ul>
							<li>Ordnung auf Parkplätzen während Veranstaltungen</li>
							<li>Verhindern von Unfällen und Staus</li>
							<li>Koordination der Zufahrten</li>
							<li>Einweisen der Fahrzeuge</li>
							<li>Optimales Nutzen der Parkflächen</li>
							<li>Inkasso und Abrechnung der Parkgebühren</li>
							<li>Ansprech- und Auskunftsstelle für Besucher und Personal</li>
						</ul>
					</div>
				</div>
				<div class="col-md-6">
					<div class="service-item wow slideInUp">
						...
						<p class="text mb-1">Zur Überprüfung von Objekten nach Alarmauslösung (Einbruch / Überfall / sonstige Alarme) halten wir Einsatzfahrzeuge bereit. Besonderen Wert legen wir darauf, dass unsere Einsatzkräfte spätestens 30 Minuten nach Alarmauslösung vor Ort sind. Durch eine hohe Dichte unserer Einsatzfahrzeuge im Großraum Thun und Interlaken sind wir aber schon meist nach wenigen Minuten am Ort des Geschehens.</p>
						<p class="text mb-1">Unsere Mitarbeiter treffen vor Ort die mit unseren Kunden individuell abgestimmten Maßnahmen. Diese können sein, die Überprüfung der Alarmursache, das Absichern von beschädigten Objekten, die Hinzuziehung der Polizei beim Vorliegen einer Straftat oder mit unseren Partner im Bereich Sicherheitstechnik, Schreinerarbeiten, Elektro Telematik oder Haustechnik (Sanitär - Heizung).</p>
					</div>
				</div>
			</div>
		</div>
